...
<meta name="description" content="Social Media Optimization | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Social Media Optimization | Learnintern & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Social Media Optimization</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Social Media Optimization </li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Social Media  <span class="text-theme-colored2">Optimization</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">Discover effective Social Media Optimization tips to increase your social media followers, engagement and conversions.</p>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
              <li>Anyone who wants to get started on Social Media.</li>
              <li>Anyone who wants to get the most from their Social Media efforts.</li>
              <li>Anyone who wants to learn social media optimization.</li>
              <li>Anyone who wants the best tips to maximize their social media presence.</li>
              <li>Anyone who's thinking about doing Social Media advertising</li>
              <li>Social Media beginners</li>
            </ul>
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
            <p style="color:black">&#10004;&nbsp;&nbsp;&nbsp;You will be able to claim and optimize your presence on the top 7 social media networks.<br/>&#10004;&nbsp;&nbsp;&nbsp;You'll know how to create your own social media strategy based on your business goals.<br/>&#10004;&nbsp;&nbsp;&nbsp; You'll discover the best social media optimization practices for the top 7 social networks.<br/>&#10004;&nbsp;&nbsp;&nbsp; You'll learn how to quickly create social media graphics.<br/>&#10004;&nbsp;&nbsp;&nbsp;You will understand the benefits of social media optimization.<br/>&#10004;&nbsp;&nbsp;&nbsp;	You'll know the best tips for getting started on social media.<br/>&#10004;&nbsp;&nbsp;&nbsp;You'll receive an updated social media optimization guide for images and content
            </p>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>A desire to learn social media optimization.</li>
