...
<meta name="description" content=" Filmora Video Editing | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Filmora Video Editing | Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Filmora Video Editing</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Filmora Video Editing</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Filmora Video Editing<span class="text-theme-colored2">Filmora Video Editing</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">FilmoraGo- the best free HD video editor and video maker with all features, text, audio, emoji, special effects, filters, backgrounds, etc. FilmoraGo is an easy-to-use, full-featured video editor loaded with powerful tools.</p>
        ...
        <div class="row">
          ...
          <li>Looking forward to a career in cyber security</li>
            ...
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
              ...
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;import video, split video and join video<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;import audio on audio track, adjust audio and apply audio effects<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;add lower third in videos<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Add customize text effects<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Adding images and Blur effect in background<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Add  transitions in video<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;add effects in video - blur, Mossaic, Arrows etc<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Add elements in video - smiley shape, arrows etc<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Add split screen - multiple screen<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Use of crop and pan and zoom<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Add green screen over on video<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Increase speed of video<br/>
