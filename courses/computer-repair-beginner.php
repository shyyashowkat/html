...
<meta name="description" content="Computer Repair Course - Beginner - Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Computer Repair Course - Beginner - Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Computer Repair Course - Beginner</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Computer Repair Course - Beginner</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Computer <span class="text-theme-colored2">Repair Course</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">Learn the skills necessary to optimize any PC and never again feel like you can't fix your own computer or others.</p>
              ...
              <a style="color:orange;width:170px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/Basics-of-Computer-Repair.pdf" download><i class="fa fa-download"></i> &nbsp;Download Course Module</a>
              </br>
              <ul>
              </br>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
              ...
              <li>People Who NEED To Save Money.</li>
            </ul>
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
            <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;You Will Learn To Do What I Charge thousands Of Rupees For.<br/>
              &#10004; &nbsp;&nbsp;&nbsp;Troubleshoot common computer problems and repair them with ease.<br/>
              &#10004; &nbsp;&nbsp;&nbsp;Harness hidden commands within Google empowering you to solve any computer problem.<br/>
              &#10004; &nbsp;&nbsp;&nbsp;Utilize methods used by computer repair professionals to repair computers.<br/>
              &#10004; &nbsp;&nbsp;&nbsp;Maximize your problem-solving capabilities by asking for assistance from experts in your field of need.<br/>
              &#10004;&nbsp;&nbsp;&nbsp;By the end of this course you will have a completely new skill set and you won't believe how simple it was..<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Learn The Secrets To Speed Up Your Computer That The Geek Squad Doesn't Want You To Know.<br/>
              &#10004;&nbsp;&nbsp;&nbsp;Make Your Computer Run Faster Than Ever.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Get Comfortable Using Your Computer.<br/>
              &#10004;&nbsp;&nbsp;&nbsp;	You Will Learn Good Practices To Keep Your Computer Running Like New On A Regular Basis.</p>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>Ask questions! My goal is to keep you out of the repair shops so ask questions.</li>
                  <li>Any Type Of Computer Running Microsoft Windows.</li>
                  <li>Take A Deep Breath And Relax It&#39;s Easier Than You Think.</li>
                </ul>
          </div>
        </div>
      </div>
