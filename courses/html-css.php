...
<meta name="description" content="HTML & CSS & Website Installation | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>HTML & CSS & Website Installation | Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">HTML & CSS & Website Installation</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">HTML & CSS & Website Installation</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">HTML & CSS & <span class="text-theme-colored2">Website Installation</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">Launch a career as a web designer by learning HTML5, CSS3, responsive design, Sass and more!</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp; Create any website layout you can imagine.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Add tasteful animations and effects with CSS3.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Support any device size with Responsive (mobile-friendly) Design.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Use common vocabulary from the design industry.</p>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>No prerequisite knowledge required</li>
