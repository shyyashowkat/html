...
<meta name="description" content="Youtube Marketing | Learnintern" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Youtube Marketing | Learnintern</title>
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <ul class="list-inline sm-pull-none sm-text-center text-right text-white mb-sm-20 mt-10">
              ...
              <li class="m-0 pl-0 pr-10">
                <a href="register.php" class="text-white"><i class="fa fa-edit mr-5"></i>Register</a>
              </li><?php }  ?>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Youtube Marketing</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Youtube Marketing |</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Youtube <span class="text-theme-colored2">Marketing</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">YouTube marketing to grow your subscribers & video views with YouTube SEO, recommendation algorithms, ads & YouTube live.<br/>
                Go ahead, sign up for the course, and let's start working on making you more successful on YouTube, starting today</p>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
              <li>Entrepreneurs who want to build a brand on YouTube and get leads.</li>
              <li>Aspiring YouTube stars interested in YouTube SEO, YouTube ads, and making great videos.</li>
            </ul>
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
            <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Create a big and successful YouTube channel with many views.
            </br>&#10004; &nbsp;&nbsp;&nbsp;Get more engagement with your videos.
          </br>&#10004; &nbsp;&nbsp;&nbsp;Build an audience and a brand on YouTube.
        </br>&#10004; &nbsp;&nbsp;&nbsp;Boost your YouTube SEO with YouTube ads.
            </br>&#10004; &nbsp;&nbsp;&nbsp;Find rapid growth for your YouTube channel
            </br>&#10004; &nbsp;&nbsp;&nbsp;Promote your channel and individual videos like a marketing professional would</p>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>Be excited for your YouTube channel's rapid growth, building a business on YouTube or generating leads from it</li>
                </ul>
          </div>
        </div>
      </div>
