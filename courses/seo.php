...
<meta name="description" content="Search Engine Optimization Onpage and Off Page Onpage and Off Page | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Search Engine Optimization Onpage and Off Page | Learnintern & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Search Engine Optimization Onpage and Off Page</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Search Engine Optimization Onpage and Off Page</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Search Engine <span class="text-theme-colored2">Optimization</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">This Specialization will teach you to optimize website content for the best possible search engine ranking. You'll learn the theory behind Google search and other search engine algorithms; you'll also build practical, real-world skills that you can apply to a career in digital marketing or online content development, including on-page and off-page optimization, optimizing for local and international audiences, conducting search-focused website audits, and aligning SEO with overall business strategies. Each course is intended to build on the skills from the previous course, thus we recommend you take the courses in the order they are listed. The Specialization culminates in a hands-on Capstone Project, in which you will apply your skills to a comprehensive SEO consulting task.</p>
              ...
              <h3 class= "text-theme-colored2">Course fee : <span style="color:black">12000/- INR</span></h3>
            </br>
              ...
              <a style="color:orange;width:170px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/search-engine-optimization-course.pdf" download><i class="fa fa-download"></i> &nbsp;Download Course Module</a>
              </br>
              <ul>
              </br>
                <li><i class="fa fa-user text-theme-colored2 mr-5"></i> &nbsp;<b>4+ Years Experienced Trainer</b></li>
                <li><i class="fa fa-calendar text-theme-colored2 mr-5"></i> &nbsp;<b>15 Days Course</b></li>
                <li><i class="fa fa-book text-theme-colored2 mr-5"></i> &nbsp;<b>4 Seats Available</b></li>
                <li><i class="fa fa-clock-o text-theme-colored2 mr-5"></i> &nbsp;<b>2 Hours Daily</b></li>
              </br>
                <li><i class="fa fa-briefcase text-theme-colored2 mr-5"></i> &nbsp;<b>100% Placement Support</b></li>
                <li><i class="fa fa-paper-plane text-theme-colored2 mr-5"></i> &nbsp;<b>Guaranteed Internship</b></li>
              </br>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
              <li>B2B, B2C, entrepreneurs, start-ups, marketers, influencers, Facebook admins, Facebook editors, content creators, creatives, advertisers, real estate agents, job seekers, local businesses, website owners, website admins, SEO help seekers, bloggers, etc.</li>
            </ul>
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
            <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;MASTER Facebook Ads, Instagram Ads, LinkedIn Ads, Google Ads & Retargeting<br/>&#10004;&nbsp;&nbsp;&nbsp; Blueprint to MASTER 210 SEO factors using our tried and tested "How to - learning by doing" approach<br/>&#10004;&nbsp;&nbsp;&nbsp;Learn how to easily create a professional looking, responsive website on WordPress (No coding required!)<br/>&#10004;&nbsp;&nbsp;&nbsp; This course will make you a No1 Digital Marketing Expert - choose to work freelance or land that highly paid job<br/>&#10004;&nbsp;&nbsp;&nbsp;Make Local Search Engine Optimisation & Google my Business (Google Maps) work for YOUR business<br/>&#10004;&nbsp;&nbsp;&nbsp	MASTER Proceed on-page, content & image SEO, Implement Rich Snippets, etc<br/>&#10004;&nbsp;&nbsp;&nbsp;LEARN powerful SEO & Social Media strategies that pro marketers use<br/>&#10004;&nbsp;&nbsp;&nbsp;  Optimise your YouTube channel for SEO & SMO <br/>&#10004;&nbsp;&nbsp;&nbsp;  Tap into a STREAM OF NEW CLIENTS & BOOST YOUR PROFITS using PROVEN Social Media Strategies <br/>&#10004;&nbsp;&nbsp;&nbsp; Become a Facebook, Instagram, and Messenger Retargeting & Remarketing MASTER  <br/>&#10004;&nbsp;&nbsp;&nbsp; Understand SEO WordPress Yoast and the Google Search Console configuration  <br/>&#10004;&nbsp;&nbsp;&nbsp; Optimise your Facebook page for SEO & SMO  <br/>&#10004;&nbsp;&nbsp;&nbsp;Optimise your Pinterest account for SEO & SMO   <br/>&#10004;&nbsp;&nbsp;&nbsp; GET POWERFUL VIDEO EDITING GUIDES & BONUS VIDEO EDITING SUPER-HACKS to create professional looking, highly shareable videos  <br/>&#10004;&nbsp;&nbsp;&nbsp; UPSKILL YOURSELF by becoming proficient in the creation of engaging video content - the MOST IN-DEMAND skill required by recruiters today!  <br/>&#10004;&nbsp;&nbsp;&nbsp;HANDY WALKTHROUGHS to Adobe Premier Pro, DJI OSMO, and Rode microphone to help you produce Video content that gets thousands of likes, clicks and shares using ONLY YOUR SMARTPHONE!</p>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>NO KNOWLEDGE of video editing, creation, SEO, or marketing NEEDED - my course will teach you EVERYTHING you need to know from scratch</li>
                  <li>YOUR SMARTPHONE, LAPTOP OR DESKTOP is all you need to MASTER the art of pro Video Creation. ZERO PRIOR KNOWLEDGE REQUIRED</li>
                  <li>With this course you'll MASTER VIDEO MARKETING, YouTube SEO, and Video SEO, and you'll understand the huge recent change in SEO using Video Featured Snippets and FAQ Featured Snippets</li>
                  <li>You'll learn POWERFUL strategies that will turn you into a highly effective Social Media Marketing MASTER and will be an EXPERT at Local SEO upon course completion</li>
                  <li>After completing this course you'll have INSIDE KNOWLEDGE of 200 INFLUENTIAL SEO factors</li>
                  <li>LEARN how to construct dynamic ads & conduct successful catalogue sales</li>
                  <li>Find out how to correctly SET UP your 1st Facebook Ads & Custom audiences</li>
                  <li>DISCOVER how to CREATE your 1st professional looking WordPress website (no coding needed!)</li>
                  <li>We'll teach you how CREATE your 1st effective Facebook Business Page</li>
                  <li>We walk you through EVERYTHING YOU NEED TO KNOW TO BECOME A DIGITAL MARKETING MASTER.</li>
                  <li>You DON'T need ANY knowledge of social media marketing, web coding, copywriting, SEO or design at all.</li>
                  <li>Determination and a hunger to learn. We will teach you the rest.</li>
                </ul>
          </div>
        </div>
      </div>
