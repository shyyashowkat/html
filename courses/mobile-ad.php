...
<meta name="description" content="Mobile Ads | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Mobile Ads | Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Mobile Ads</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Mobile Ads</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Mobile <span class="text-theme-colored2">Ads</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">Mobile Ads Masterclass: Learn Mobile Ads from A-Z.</br>
                Create professional mobile ads that convert, define KPIs and create eye-catching mobile content on popular social Media sites.</p>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
              <li>Online marketing professionals who would like to know more about mobile ads</li>
              <li>Entrepreneurs who would like to sell their products online through Facebook mobile ads</li>
              <li>Everyone who wants to run mobile ads successfully</li>
            </ul>
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
            <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Create professional mobile ads that convert.<br/>
              &#10004;&nbsp;&nbsp;&nbsp;Split testing for creative, delivery optimization, placement and audience.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Take a data-driven approach to Facebook paid advertising.<br/>
              &#10004;&nbsp;&nbsp;&nbsp;Define KPIs (key performance indicators) and learn to track them.<br/>
              &#10004;&nbsp;&nbsp;&nbsp;Create eye-catching mobile content that impresses your followers</p>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>You need an ads account</li>
                  <li>You need a marketing budget</li>
            ...
            <div class="col-md-6 text-right">
              <div class="widget no-border m-0">
                <ul class="list-inline sm-text-center mt-5 font-12">
                  ...
                  <li>|</li>
                  <li>
                    <a href="/contact-us.php">Help Desk</a>
                  </li>
                  <li>|</li>
                  <li>
                    <a href="#">Support</a>
