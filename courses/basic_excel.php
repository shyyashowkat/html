...
<meta name="description" content="Basic Excel | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Basic Excel | Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Basic Excel</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Basic Excel</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Basic Excel<span class="text-theme-colored2">Basic Excel</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">a software program created by Microsoft that uses spreadsheets to organize numbers and data with formulas and functions. Excel analysis is ubiquitous around the world and used by businesses of all sizes to perform financial analysis.</p>
              ...
              <h3 class= "text-theme-colored2">Course fee : <span style="color:black">5000/- INR</span></h3>
            </br>
              ...
              <a style="color:orange;width:210px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/basic_excel.txt" download><i class="fa fa-download"></i> &nbsp;Download Basic Excel Module</a><br>
              </br>
              <ul>
            </br>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
              ...
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Excel formula and function<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Excel Shortcuts<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Excel If Formula<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Excel Chart<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Excel Home Tab<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Excel Filter<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Excel Sort<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Excel Print Tips<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Excel Data entry Tips<br/>
