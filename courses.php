            ...
            <div class="section-title text-center">
              ...
              <div class="row mtli-row-clearfix">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <div class="course-single-item style2 text-center mb-40">
                      <div class="course-thumb">
                        <img class="img-fullwidth" alt="C,CPP, DSA" src="/images/course/c-cpp-dsa.png">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                    <div class="course-single-item style2 text-center mb-40">
                      <div class="course-thumb">
                        <img class="img-fullwidth" alt="Python and Django" src="/images/course/python-django.jpeg">
                        <div class="price-tag">25000 INR</div>
                        <div class="order-btn"><a href="https://rzp.io/l/bo61s9oAi" class="btn btn-xs btn-theme-colored2">Get it now</a></div>
                      </div>
                      <div class="course-details clearfix p-20 pt-15">
                        <div class="course-top-part pull-left mr-40">
                          <a href="/courses/python_django.php"><h4 class="mt-0 mb-5">Pyhton and Django</h4></a>
                          <ul class="list-inline">
                            <li class="review-stars">
                              <i class="fa fa-star"></i>
                              <i class="fa fa-star"></i>
