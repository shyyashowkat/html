...
<meta name="description" content="Learn English - Spoken and Written |  Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Learn English - Spoken and Written | Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Learn English - Spoken and Written</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Learn English - Spoken and Written</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Learn English<span class="text-theme-colored2"> - spoken and written </span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">A new course for English learners. Certified trainers designed this course for students. </br>
                Each week, there will be a new lesson. The lesson includes instruction in speaking, vocabulary and writing.</br>
                There are also printable worksheets, assessments and lesson plans for individual learners and English teachers. We encourage you to follow the weekly lessons and share your progress with us through comments and email.</p>
              ...
              <h3 class= "text-theme-colored2">Course fee : <span style="color:black">24000/- INR </span><span style="font-size:16px"> (3000 INR per month)</span></h3>
            </br>
              ...
              <ul>
                ...
                <li><i class="fa fa-calendar text-theme-colored2 mr-5"></i> &nbsp;<b>240 Days Course</b></li>
