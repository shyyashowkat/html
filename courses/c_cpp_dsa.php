...
<meta name="description" content="C, C++ and DSA | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>C, C++ and DSA | Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">C C++ and DSA</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">C, C++ and DSA</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Language, Data Structure and Algorithm<span class="text-theme-colored2">C, C++ and DSA</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">The C programming language is a computer programming language that was developed to do system programming for the operating system UNIX and is an imperative programming language. C was developed in the early 1970s by Ken Thompson and Dennis Ritchie at Bell Labs.</p>
              ...
              <h3 class= "text-theme-colored2">Course fee : <span style="color:black">15000/- INR</span></h3>
            </br>
              ...
              <a style="color:orange;width:210px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/Learn C CPP and DSA Course.pdf" download><i class="fa fa-download"></i> &nbsp;Download C, C++ and DSA Module</a><br>
              </br>
              <ul>
            </br>
        ...
        <div class="row">
          ...
          <li>Looking forward to a career in cyber security</li>
            ...
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
              ...
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Introduction to C++ Language<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Introduction to DSA Language<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;The Decision Control Structure<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;The Loop Control Structure<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Arrays and Pointers<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Functions and Pointers<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Working with Structure<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Working with File Input/Output<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Functions in C++<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Classes and Objects<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Constructors and Destructors<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Working with Files<br/>
