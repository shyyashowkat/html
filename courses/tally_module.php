...
<meta name="description" content="Python and Django | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Tally Module | Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Tally Module</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Tally Module</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Tally Module<span class="text-theme-colored2">Tally Module</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">Tally software has become the most wanted accounting software in many enterprises, Few Tally modules may automate the processes including auto emailing, workflow management, auto backup, audit trail, excel import, invoice format, and many more.</p>
              ...
              <a style="color:orange;width:210px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/tally_module.txt" download><i class="fa fa-download"></i> &nbsp;Download Tally Module</a><br>
              </br>
              <ul>
            </br>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
              <li>Eager to learn Tally  once and for all</li>
              <li>Looking forward to a Tally</li>
              <li>Tally software has become the most wanted accounting software in many enterprises</li>
              <li>Willing to write their own Dashboard</li>
              <li>Want to Saves time from mail typing and attachment</li>
              <li>Using this module, the Tally accounting software user can restrict to make invoice when there is no stock</li>
            </ul>
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;What is Tally?<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;What is Accounting?<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Qualification to Learn Tally?<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Download & Install Tally ERP9<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;How to Start Learning Tally<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;What is Financial Year<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;What is GST<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;What is Regular & Composition Firms<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;How to Create Company in Tally<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Gateway of Tally introduction<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;How to Activate GST features in Tally<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;What is Voucher in Tally<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;What is Ledger & Group in Tally<br/>
