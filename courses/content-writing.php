...
<meta name="description" content="Content Writing and Influencer marketing | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Content Writing and Influencer marketing | Learnintern & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Content Writing and Influencer marketing</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Content Writing and Influencer marketing</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Content Writing and<span class="text-theme-colored2"> Influencer marketing</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">Influencer marketing is the practice of engaging internal and industry experts with active networks to help achieve measurable business goals. <br/>
                This course is about strategy. Although there is no all-purpose, one-size-fits-all influencer marketing strategy template, you will learn how to tailor one for a wide variety of B2B, B2C, and nonprofit organizations using the two-step flow model of communication.</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <div class="double-line-bottom-theme-colored-2"></div>
            <h4 class="text-theme-colored2">What are the benefits of Content Writing Course?</h4>
            <ul style="list-style-type:disc">
              <li>Skill to Translate Thoughts into Words that Attracts</li>
              <li>Experience of Professional Content Writing</li>
              <li>Develop essential Language Skills to write for International Clients</li>
              <li>Website Making Skills to create Basic Website and Personal Blog</li>
              <li>Graphic Skills to design Newsletters, PPT, Logo etc</li>
              <li>Gain Advanced Research Skills that enables to Write on Any Topic</li>
              <li>Skill to Identify Target Audience Persona for your Content</li>
            </ul>
            <h4 class="text-theme-colored2">What skills will you learn from this course ?</h4>
                <ul style="list-style-type:disc">
                  <li>Trainer: Seasoned industry experts with 10+years experience</li>
                  <li>Live Projects: Experience Industry Projects during the training</li>
                  <li>E-Learning Access: Includes Recorded Videos, Games, Projects, Case Studies</li>
                  <li>Internship: Guaranteed Internship with Henry Harvin or partner firms</li>
                  <li>Job Opportunities: Job Opportunities every week</li>
                </ul>
          </div>
        </div>
      </div>
