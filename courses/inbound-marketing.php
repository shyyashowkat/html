...
<meta name="description" content="Inbound Marketing | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Inbound Marketing | Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Inbound Marketing</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Inbound Marketing</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Inbound <span class="text-theme-colored2">Marketing</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">Attract More Visitors, Generate More Leads, Convert More Customers, Increase Your Revenue.<br/>
                Learn how to increase customer retention through nurturing and create champions who will add to your referral stream of income.</p>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
              <li>Small business owners who want to start driving more traffic and generating more leads online</li>
              <li>Online marketing freelancers who want to offer inbound marketing services to their clients</li>
              <li>Entrepreneurs who have a website that isn't helping their businesses grow</li>
            </ul>
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
            <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Learn how to increase customer retention through nurturing and create champions who will add to your referral stream of income.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Learn how to attract customers to you so you don't have to chase them down.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Gain a complete understanding of how Inbound Marketing works and how you can use it to automate your lead generation and generate business growth.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Learn how to increase visitors to your website so you can easily generate more leads.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Learn how to nurture your leads so you can convert more leads into customers.<br/></p>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>Students should have some type of already established online presence (like a website and social media channels).</li>
                </ul>
          </div>
        </div>
      </div>
