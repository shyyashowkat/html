    ...
    <section>
      <div class="container">
        <div class="section-content">
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8">
              ...
              <ul class="nav nav-tabs" role="tablist">
                  <li role="presentation" class="active"><a href="#payment" aria-controls="payment" role="tab" data-toggle="tab" class="font-15 text-uppercase">Payment Info. <span class="badge"></span></a></li>
                  <?php if ($_SESSION['type'] == 'students') {?>
                  <li role="presentation"><a href="#premium" aria-controls="premium" role="tab" data-toggle="tab" class="font-15 text-uppercase">Premium Course <span class="badge">5</span></a></li>
                    ...
                    <table class="table">
                       <tbody>
                          <tr>
                             ...
                             <td><h4>Rs.25000</h3></h4>
                             <td><h4><a class="btn btn-warning btn-xs" href="#">Premium Download</a></h4></td>
                             <td><h4><a href="#"><i class="fa fa-close"></i></a></h3></h4>
                          </tr>
                          <tr>
                             <th scope="row"><img src="http://placehold.it/100x50" alt=""></th>
                             <td><h4>Software Development Course</h3></h4>
                             <td><h4>Rs.27000</h3></h4>
                             <td><h4><a class="btn btn-warning btn-xs" href="#">Premium Download</a></h4></td>
                             <td><h4><a href="#"><i class="fa fa-close"></i></a></h3></h4>
                          </tr>
                          <tr>
                ...
                <p class="mb-15">Though, to get more effective course modules and to get tuitions from experienced trainers, Students can buy PREMIUM MEMBERSHIP. </p>
                ...
                <p><a style="color:#37BF91" href="/">Take our PREMIUM MEMBERSHIP and get the best possible advantages.</a></p>
              </div>
            </div>
          </div>
        </div>
          ...
          <section>
          <div class="container p-0 text-center" style="max-width: 700px;">
            <button type="button" style="border-radius:25px" class="btn btn-colored btn-flat btn-theme-colored text-white" onclick="document.querySelector('.files').style.display='block';">Upload more modules</button>
          	  <div class="border border-primary rounded mb-30" style="background-color:#d4d4d6;">
          	<div class="col-md-12 mb-20 files" style="display: none">
            ...
            <form id="upload" action="" method="POST"  class="reservation-form bg-silver-deep" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="file" id="fileselect" accept="application/pdf" name="fileselect[]" class="form-control text-center" multiple="multiple" />
                </div>
                <div id="submitbutton">
        ...
        if (isset($_POST['submitmodule'])) {
          ...
          for( $i=1 ; $i <= $total_count ; $i++ ) {
             ...
             if ($tmpFilePath != ""){
               $fileName = rand(1, 10000) . '_' . $_FILES['fileselect']['name'][$i];
                //Setup our new file path
                $newFilePath = "trainer/curriculum/" . $fileName;
                //File is uploaded to temp dir
                if(move_uploaded_file($tmpFilePath, $newFilePath)) {
          			     $query1 = "INSERT INTO multi_module (email, mod1) VALUES ('$user', '$fileName')";
          			     $result11 = mysqli_query($conn, $query);
          			           if ($result1) {
                             echo "<script>alert('Module(s) Uploaded Successfully!');</script>";
          			              }
                           else{
                             echo "<script>alert('Failed! Some error occured while saving in database');</script>";
                           }
                  }
                else {
                  echo "<script>alert('Failed! Some error occured while saving in server');</script>";
                }
          }}} ?>
          	</div>
          	</div>
