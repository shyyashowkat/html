...
<meta name="description" content="Social Media Marketing - Advance | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Social Media Marketing - Advance | Learnintern & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Social Media Marketing - Advance</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Social Media Marketing - Advance </li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Social Media Marketing<span class="text-theme-colored2"> - Advance</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">Discover effective Social Media Marketing tips to increase your social media followers, engagement and conversions.<br/>
              Become expert in online marketing on Twitter, Pinterest, Instagram, YouTube, Facebook, Google and more ad platforms!</p>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
              <li>ANYONE looking to MASTER the most highly targeted and cheapest advertising strategies online!</li>
              <li>New or Advanced MARKETERS looking to learn how to create ads on all the social media networks!</li>
              <li>Business Owners.</li>
              <li>Influencers / Bloggers / Celebs / Public Figures.</li>
              <li>Social Media Marketing Employees.</li>
            </ul>
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
            <p style="color:black">&#10004;&nbsp;&nbsp;&nbsp; Understand everything about Social Media Marketing!<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Learn Instagram Marketing A-Z and how to monetize the social platform.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; MASTER YouTube marketing, including: layout, content creation, and video ads!<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Use Web 2.0 blogs to further expand your reach with SEO and content marketing.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Learn the power of Pinterest promoted pins and ALL the Pinterest Marketing strategies we implement for our clients!<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Become a Facebook Ads Expert!<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Learn Twitter Marketing strategies for LASER focused ads..<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Optimize your LinkedIn profile and use LinkedIn ads to grow your business.</br>
              &#10004;&nbsp;&nbsp;&nbsp; Learn social media marketing posting automation via IFTTT.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Use Google Business to benefit your local business and help your Search Engine Optimization.<br/>
            </p>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>Ask us ANY questions in the discussion section, We are here to help you master Social Media Marketing!</li>
                  <li>A desire to grow your businesses via Social Media Marketing!</li>
                </ul>
          </div>
        </div>
      </div>
