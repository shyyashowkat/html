...
<meta name="description" content="SMS Marketing | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>SMS Marketing | Learnintern & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">SMS Marketing</h2>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">SMS <span class="text-theme-colored2">Marketing</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">SMS Marketing course will transform you into a complete digital marketer with expertise in the top eight digital marketing domains — search engine optimization, social media, pay-per-click, conversion optimization, digital analytics, content, mobile, and email marketing. Fast-track your career in digital marketing today with practical training you can apply on the job.</p>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <h4 class="text-theme-colored2">What are the course objectives ?</h4>
              <p>This online Advance SMS Marketing For Experts course gives you an in-depth understanding and advanced knowledge of the eight most important digital marketing domains and includes real-world projects and virtual simulations for gaining domain experience. You’ll be exposed to 40+ digital marketing tools extensive project experience and Mimic Pro simulations to make you job-ready.</p>
              <p>After you have completed this SMS marketing certification program, you will receive a Master's certificate from LearnIntern stating that you have acquired the skill set of a SMS Marketing  Specialist, validating your ability to lead digital marketing efforts in your organization.</p>
              <h4 class="text-theme-colored2">What skills will you learn from this SMS MARKETING course ?</h4>
              <p>Digital marketing encompasses a range of disciplines, and there is an enormous demand for digital marketers with the right skills. This SMS marketing certification program provides access to live instructor-led online classes conducted by multiple expert trainers. You will also get access to the highest quality of e-learning content, simulation exams, a community moderated by experts, monthly mentoring sessions by experts, and other resources to help you master the complete SMS marketing skillset. This SMS marketing course will help you to:</p>
