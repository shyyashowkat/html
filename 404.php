...
<div id="wrapper" class="clearfix">
          ...
          <div class="container pt-0 pb-0">
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                ...
                <a class="btn btn-border btn-gray btn-transparent btn-circled smooth-scroll-to-target" href="/" onclick="location.href='/'">Return Home</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <footer id="footer" class="footer text-center" data-bg-color="#2b2d3b">
    <div class="container pt-15 pb-15">
      <div class="row">
        <div class="col-md-12">
          <p class="text-white mb-0">Copyright &copy;2020 Essential Services. All Rights Reserved</p>
        </div>
      </div>
    </div>
  </footer>
