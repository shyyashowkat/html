...
<meta name="description" content="Basics of Email Marketing | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Basics of Email Marketing | Learnintern & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Basics of Email Marketing</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Basics of Email Marketing</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Basics of <span class="text-theme-colored2">Email Marketing</span></h3>
              ...
              <a style="color:orange;width:170px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/Basics-of-Email-Markeing.pdf" download><i class="fa fa-download"></i> &nbsp;Download Course Module</a>
              </br>
              <ul>
              </br>
