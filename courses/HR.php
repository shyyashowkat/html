...
<meta name="description" content="Human Resource Management | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Human Resource Management | Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Human Resource Management</h2>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Human Resource  <span class="text-theme-colored2">Management</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">A Professional guide to Human Resource Management.<br/>
                It covers every aspect of human resource management from the planning, recruitment, selection, training, performance management, to the compensation. </p>
              ...
              <a style="color:orange;width:170px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/HR.pdf" download><i class="fa fa-download"></i> &nbsp;Download Course Module</a>
              </br>
              <ul>
              </br>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
              <li>Everyone</li>
              <li>Everyone aspiring leadership</li>
              <li>Business owners</li>
              <li>Entrepreneurs</li>
              <li>Employers</li>
              <li>Employees</li>
              <li>Business managers</li>
              <li>Public office holders</li>
            </ul>
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
            <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp; Manage personnel.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Write Job description and job specifications.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Train and develop work team.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Appraise performances.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Measure compensable factors.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Organise, formulate and implement policies.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Conduct selection tests and interviews.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Manage performances.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Draw out compensation plans.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Draw out succession plan.<br/></p>
