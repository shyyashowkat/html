...
<meta name="description" content="Internet Speed Test | LearnIntern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />

<!-- Page Title -->
<title>Internet Speed Test | LearnIntern & Grow</title>
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Test your Internet Speed</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                <li class="active">Internet Speed Test</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <div style="text-align:right;">
      <div style="min-height:360px;">
        <div style="width:100%;height:0;padding-bottom:50%;">
          <iframe class="text-theme-colored2" style="border:none;width:100%;height:100%;min-height:360px;border:none;overflow:hidden !important;" src="//openspeedtest.com/Get-widget.php">

          </iframe>
        </div>
      </div>Provided by  <a class="text-theme-colored2" href="/">Learnintern.com</a>
    </div>
          <!-- OST Widget code end -->
