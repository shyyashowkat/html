...
<meta name="description" content="Advance Email Marketing + Server Setup | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Advance Email Marketing + Server Setup | Learnintern & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Advance Email Marketing + Server Setup</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Advance Email Marketing + Server Setup</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Advance Email Marketing <span class="text-theme-colored2">+ Server Setup</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">Email marketing is one segment of a company's overall digital marketing strategy. Email marketing is the use of email to promote products or services and to develop a relationship with a database of existing and potential customers, that helps us achieve our marketing goals.</p>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
              <li>Anyone who wants to become an expert digital marketer, promote a business, or know more about digital marketing</li>
            ...
            <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Proven Tips and Tricks of the Digital Marketing Trade<br/>&#10004;&nbsp;&nbsp;&nbsp; How to Generate More Traffic and Leads for Your Brand<br/>&#10004;&nbsp;&nbsp;&nbsp; Growth Hacking<br/>&#10004;&nbsp;&nbsp;&nbsp; Marketing Strategy<br/>&#10004;&nbsp;&nbsp;&nbsp; Unique Ways of Promoting a Business from Scratch<br/>&#10004;&nbsp;&nbsp;&nbsp;	Digital Marketing Tools and Strategies<br/>&#10004;&nbsp;&nbsp;&nbsp;Inbound Marketing</p>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>Internet connection</li>
                  <li>No digital marketing experience required</li>
                  <li>Pen and paper for taking notes</li>
                  <li>Basic understanding of business</li>
