...
<!-- Page Title -->
<title>Ethical Hacking | Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Ethical Hacking</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Ethical Hacking</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              ...
              <a style="color:orange;width:210px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/Learn Hacking Course.pdf" download><i class="fa fa-download"></i> &nbsp;Download Ethical Hacking Module</a><br>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
                <li>Eager to learn ethical hacking once and for all</li>
          <li>Looking forward to a career in cyber security</li>
            <li>Want to learn Python programming for ethical hacking</li>
              <li>Willing to write their own cyber security tools</li>
                <li>Passionate for Kali Linux and general ethical hacking tools</li>
            ...
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
              ...
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Fundamental ethical hacking attacks & protection methods<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Metasploit<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Python<br/>
              <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Writing ethical hacking tools with Python<br/>
