...
$mail->Subject = 'New Trainer registered in Learnintern.com';
        ...
        <div class="container p-0 " style="max-width: 700px;">
          <div class="row">
              <div class="col-md-12">
                ...
                <br><br><h3 class="text-center mt-0 mb-30">REGISTER<span class="text-theme-colored2"> AS A TRAINER</span></h3>
                ...
                <div class="row pl-20 pr-20">
                  ...
                  <div class="col-md-6">
                    <div class="zoom form-group mb-30">
                      <input  placeholder="Enter State" id="state" name="state" required="Required" class="form-control" type="text">
                    </div>
                  </div>
                  </div>
                  <div class="row pl-20 pr-20">
                  <div class="col-md-6">
                    <div class="form-group mb-30">
                      <label for="" >Upload Your Photo (max. size: 200 X 170 px)</label><input class="zoom border border-success" placeholder="Upload Your Photo" type="file" onchange="Filevalidation2()" id="myphoto" accept="image/*" required="Required" name="photo" class="form-control" aria-required="true" maxlength="1">
                  ...
                  <div class="col-md-6">
                    <div class="form-group mb-30">
                      <label for="" >Upload Your Resume </label><input class="zoom border border-success" placeholder="Upload Your CV" type="file" id="mycv" accept="application/pdf" onchange="Filevalidation()" required="Required" name="cv" class="form-control" aria-required="true" maxlength="1">
              ...
              <div class="border border-primary rounded mb-30" style="background-color:#EEE;">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class=" zoom form-group mb-30">
                    <input name="experience" type="number" min="0" max="20" placeholder="Total Experience (in Years)" class="form-control" required="Required" aria-required="true">
                    </div>
                  </div>
                </div>
                <div class="row pl-20 pr-20">
                      <div class="col-md-6">
                        <div class="form-group mb-10">
                          <label for="" >Upload Your Module</label>  &nbsp;&nbsp;i.e. Teaching Syllabus (only pdf format supported)<input class="zoom border border-success" type="file" id="curriculum" accept="application/pdf" onchange="Filevalidation1()" required="Required" name="curriculum" class="form-control" aria-required="true" maxlength="1">
                          <div><span id="cursize"></span></div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="zoom form-group mb-10">
                    ...
                    <div class="row pl-20 pr-20">
                      <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" name="intro" placeholder="Introductory Video Link (Eg: https://youtu.be/xyz)">
                      </div>
                    </div>
                </div>
                  <div class="border border-primary rounded mb-30" style="background-color:#EEE;">
                  ...
                  <div class="row pl-20 pr-20">
                    ...
                    <div class="col-md-7">
                      <div class="form-group mt-15 text-center">
                        <p>wanna learn new technologies? <a id="" href="/register.php" class="text-theme-colored2 text-underline">Register now as a student!</a> </p>
                      </div>
                    </div>
                  </div>
