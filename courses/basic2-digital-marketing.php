...
<meta name="description" content="Basics of Complete Digital Marketing | Learnintern  & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Basics of Complete Digital Marketing | Learnintern & Grow</title>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <ol class="breadcrumb text-left mt-10 white">
                ...
                <li class="active">Basics of Complete Digital Marketing</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Basics of Complete <span class="text-theme-colored2">Digital Marketing</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">This Basics of complete Digital Marketing course will transform you into a digital marketer with expertise in the digital marketing domains — search engine optimization, social media, pay-per-click, digital analytics, content, mobile, and email marketing. Fast-track your career in digital marketing today with practical training you can apply on the job.</p>
              ...
              <span class="fa fa-star checked"></span> </p>
                <h3 class= "text-theme-colored2">Course fee : <span style="color:black">25000/- INR</span></h3>
              </br>
                ...
                <a style="color:orange;width:170px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/Basic Digital Marketing.pdf" download><i class="fa fa-download"></i> &nbsp;Download Course Module</a>
                </br>
                <ul>
                </br>
                  <li><i class="fa fa-user text-theme-colored2 mr-5"></i> &nbsp;<b>4+ Years Experienced Trainer</b></li>
                  <li><i class="fa fa-calendar text-theme-colored2 mr-5"></i> &nbsp;<b>45 Days Course</b></li>
