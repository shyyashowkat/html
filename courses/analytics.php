...
<meta name="description" content="Google Analytics | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Google Analytics | Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Google Analytics</h2>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Analytics <span class="text-theme-colored2">- Google</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">The goal of this course is to teach you Google Analytics as a tool, but what is more important to teach you how to use the data to drive your business. We'll start with the very basic topics such as how the measurement works, basic metric definition, socio-demo data to website traffic evaluation, UTM parameters, internal site search, website speed optimization or segmentation.</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Understand how the tool works, what data is there and the most important find the business value in it.<br/>
              &#10004;&nbsp;&nbsp;&nbsp;Know which are important Google Analytics reports.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; You'll practice achieved knowledge with 100 quiz questions.<br/>
              &#10004;&nbsp;&nbsp;&nbsp;Ability to make the right data decisions.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Among others we'll go through 50 practical examples!.<br/>
              &#10004;&nbsp;&nbsp;&nbsp;	How to think in context and not act hastily.</p>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>Access to some Google Analytics account.</li>
                  <li>The will help to learn and move the business forward.</li>
                </ul>
          </div>
        </div>
      </div>
