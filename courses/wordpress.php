...
<meta name="description" content="Wordpress Installation and Website Designing - Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Wordpress Installation and Website Designing - Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Wordpress Installation and Website Designing</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Wordpress Installation and Website Designing</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Wordpress Installation <span class="text-theme-colored2"> and  Website Designing</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">It's never been easier to build a fantastic, responsive website that looks great on computers, tablets, and mobile phones.  <br/>
                You can learn Wordpress WITHOUT having to buy web hosting or a domain name.  we'll show you how you can set it all up on your own computer using free tools.</p>
              ...
              <a style="color:orange;width:170px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/Website-Development-Module.pdf" download><i class="fa fa-download"></i> &nbsp;Download Course Module</a>
              </br>
              <ul>
              </br>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
              <li>Computer Beginners</li>
              <li>Want to learn more about using your computer</li>
            </ul>
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
            <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp; Install Wordpress on your PC or Mac computer, so you can learn without having to pay hosting or domain fees.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Navigate around the Wordpress dashboard, know what everything does and how to use it.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Create pages and posts, and most importantly, know the difference between the two.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Correctly use post categories and tags, and understand why these can cause you problems at the search engines if used incorrectly.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Understand plugins & themes and how to find/install them.<br/>
                &#10004;&nbsp;&nbsp;&nbsp; Create a static homepage useful for most websites, or a blog like homepage useful for bloggers.<br/>
                &#10004;&nbsp;&nbsp;&nbsp; Create a Responsive Website that looks good on any browser.<br/>
                &#10004;&nbsp;&nbsp;&nbsp; This course will teach anyone to build a functional, beautiful, responsive website with Wordpress.<br/>
                &#10004;&nbsp;&nbsp;&nbsp; Create custom menus and navigation systems that both visitors and search engines will find useful.<br/>
                &#10004;&nbsp;&nbsp;&nbsp; Protect their Wordpress website from hackers and spammers.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Create an affiliate site for passive, recurring income.</p>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>No prior knowledge of Wordpress is required as everything will be covered in this course.</li>
                    <li>You will need a working computer and a web browser connected to the internet.</li>
