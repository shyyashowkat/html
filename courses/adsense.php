...
<meta name="description" content="Adsense - Youtube | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Adsense - Youtube | Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Adsense - Youtube</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Adsense - Youtube</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Adsense <span class="text-theme-colored2">- Youtube</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">Google AdSense & YouTube: Everything You Need to Know</b><br/>
                Start making a solid income working online, be your own boss and get paid monthly by Google</p>
              ...
              <a style="color:orange;width:170px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/Adsense.pdf" download><i class="fa fa-download"></i> &nbsp;Download Course Module</a>
              </br>
              <ul>
            </br>
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;You will be able to teach other students.<br/>
              &#10004;&nbsp;&nbsp;&nbsp;Started Get paid by linking AdSense to your YouTube account.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; Will Be able to Apply for Adsense the right way.<br/>
              &#10004;&nbsp;&nbsp;&nbsp;Will be able to get payment from google adsense monthly.</p>
              <h4 class="text-theme-colored2">Topics:</h4>
                  <ul style="list-style-type:disc">
                    <li>How to Create Gmail Account</li>
                    <li>How you will earn money Online via YouTube Using Google Adsense Partners</li>
                    <li>YouTube monetization</li>
                    <li>You can earn money and get paid monthly </li>
                    <li>How to edit YouTube video</li>
                    <li>How get YouTube keywords</li>
                    <li>How to save your video by copyright attack</li>
                    <li>How to edited YouTube videos</li>
                    <li>How to use Camtasia video studio for edition videos</li>
                    <li>How to generate auto tag and auto video description.</li>
                    <li>How to save you video by copyright attack</li>
                  </ul>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>Have a Website</li>
                    <li>Have the well to make a difference</li>
                      <li>No need for any academic qualifications or previous experience</li>
                        <li>A well, determination.</li>
                          <li>The ability to apply, not just watch..</li>
                </ul>
          </div>
        </div>
      </div>
