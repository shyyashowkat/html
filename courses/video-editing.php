...
<meta name="description" content="Video Ads Making & Video Editing | Learnintern" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Video Ads Making & Video Editing | Learnintern</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Video Ads Making & Video Editing</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="index.php">Home</a></li>
                  <li><a href="courses.php">Courses</a></li>
                <li class="active">Video Ads Making & Video Editing</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Video Ads making And <span class="text-theme-colored2">Video Editing</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">Learn what you need to know to edit your videos and get your audience engaged.<br/>
                This course is for you if you don't aim to be an expert in a software or in Editing; you just want to be able to do the work yourself. I have made it simple and easy to follow, so you can go right to the point and learn the essentials in a short time.</br>
                The lessons are tailor-made for you who own a channel and want to enhance your work. If you don't post videos yet, this is also a great chance to learn, as it is beginner level.</p>
              <a style="color:#3d3030" href="/about-us.php#review">Ratings and Reviews :
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
              <li>This course is for you who want to learn in a short time how to edit your videos.</li>
              <li>If you want your videos to look great and be pleasant to watch, and also add some effects in it.</li>
            </ul>
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
            <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Proven Tips and Tricks of the Digital Marketing TradeBeing able to edit a video from scratch, adding music, motion graphics and visual effects.</p>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>PC or Mac + Adobe Premiere and Adobe After Effects</li>
                </ul>
          </div>
        </div>
      </div>
