...
<meta name="description" content="Basic Computer Course | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Basic Computer Course | Beginner - Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Basic Computer Course</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Basic Computer Course</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Basic Computer<span class="text-theme-colored2"> Course</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">Become a master of computers. In two weeks, you will understand how computers work and how to use them well.<br/>
              Learn from a highly rated instructor with over 4+ years of experience teaching individuals of all ability levels.</p>
              ...
              <a style="color:#8bd0e8;width:220px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/Microsoft-Office-Word-Training-Module.pdf" download><i class="fa fa-download"></i> &nbsp;Download Word Course Module</a>
            </br><a style="color:orange;width:220px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/Microsoft-Office-PowerPoint-2019.pdf" download><i class="fa fa-download"></i> &nbsp;Download Power-Point Course Module</a>
          </br><a style="color:green;width:220px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/Microsoft-Office-Excel-2019.pdf" download><i class="fa fa-download"></i> &nbsp;Download Excel Course Module</a>
              </br>
              <ul>
              </br>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
              <li>Everyone, who want to learn</li>
              <li>A computer running Windows 7 (most concepts can be applied to Windows 10 and Windows 8)</li>
              <li>From beginners, to advanced users, this course is perfect for all ability levels. This course will add value to everyone's skill set.</li>
            </ul>
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
            <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Learn from a highly rated instructor with over 20 years of experience teaching individuals of all ability levels.<br/>
              &#10004; &nbsp;&nbsp;&nbsp;Learn incredibly valuable hands-on computer skills.<br/>
              &#10004; &nbsp;&nbsp;&nbsp;Lifetime access to this course allows you to easily review material and continue learning new material.<br/>
              &#10004; &nbsp;&nbsp;&nbsp;Money Back Guarantee - Satisfaction Guaranteed or Your Money Back.<br/>
              &#10004; &nbsp;&nbsp;&nbsp;From the fundamentals, to the most advanced features, this course covers everything you need to know to use computers well.<br/>
              &#10004;&nbsp;&nbsp;&nbsp;Presented with high-quality video lectures, this course will visually show you how to easily do everything with computers.<br/>
              &#10004;&nbsp;&nbsp;&nbsp; After taking this course, you will have a thorough understanding of how to use computers well.<br/></p>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>Suitable for all ability levels. Perfect for beginners while also being valuable to advanced users who will also learn valuable new insights and skills.
                  <li>Microsoft Office will be used for a portion of the hands-on skills.</li>
                </ul>
          </div>
        </div>
      </div>
