...
<meta name="description" content="Affliate Marketing | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Affliate Marketing | Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Affliate Marketing</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Affliate Marketing</li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Affliate <span class="text-theme-colored2">Marketing</span></h3>
					  	<div class="double-line-bottom-theme-colored-2"></div>
              <p class="mt-20">This is a structured and practical course that will teach you a viable and easy-to-follow system to make money online through promoting ClickBank products.<br/>
                You will discover how easy it is to get started by learning the core technique of Direct Linking through Search Engine Pay Per Click marketing – you don't need to have a website, domain, hosting, whatsoever.</p>
              ...
              <a style="color:orange;width:170px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/Affiliate-marketing-course.pdf" download><i class="fa fa-download"></i> &nbsp;Download Course Module</a>
              </br>
            </br>
              <ul>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 mb-md-50">
            ...
            <ul style="list-style-type:disc">
              <li>This course is ideal for people who have been trying to make money with ClickBank with little or no success.</li>
              <li>This course is NOT for people who are looking for quick ways to make money online. Everything in this course takes time and effort to see results.</li>
              <li>It is also suitable for people who do not have any prior experience with promoting ClickBank products.</li>
            </ul>
            <h4 class="text-theme-colored2">What you'll learn ?</h4>
            <p style="color:black">&#10004; &nbsp;&nbsp;&nbsp;Gain the knowledge to select good, profitable ClickBank products to promote.<br/>&#10004;&nbsp;&nbsp;&nbsp;Gain the skill to boost your campaign performance by tracking keywords that lead to actual sales.<br/>&#10004;&nbsp;&nbsp;&nbsp; Learn how to promote ClickBank products on Facebook with zero dollars.<br/>&#10004;&nbsp;&nbsp;&nbsp; Gain the skill to create a profitable advertising campaign and make money with ClickBank without a website.<br/>&#10004;&nbsp;&nbsp;&nbsp; Gain the skill to build your own squeeze page (without a domain) and attract subscriber opt-ins.<br/>&#10004;&nbsp;&nbsp;&nbsp;	Discover new concepts and marketing strategies that you can apply to other affiliate marketing programs besides ClickBank.</p>
            <h4 class="text-theme-colored2">Requirements?</h4>
                <ul style="list-style-type:disc">
                  <li>There are supplementary tools introduced in the course that require additional investment but they are optional.</li>
                  <li>This course will require some investment outlay for online marketing purposes.</li>
                </ul>
          </div>
        </div>
      </div>
