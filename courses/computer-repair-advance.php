...
<meta name="description" content="Computer Repair Course - Advance | Learnintern & Grow" />
<meta name="keywords" content="education,school,university,educational,learn,learning,teaching,workshop" />
<!-- Page Title -->
<title>Computer Repair Course - Advance | Learnintern  & Grow</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="/images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Computer Repair Course - Advance</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="/">Home</a></li>
                  <li><a href="/courses.php">Courses</a></li>
                <li class="active">Computer Repair Course - Advance</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              ...
              <a style="color:orange;width:170px;border-radius: 25px;" class="btn btn-dark btn-xs btn-flat mt-0" href="/free-modules/Advance-Computer-Repair.pdf" download><i class="fa fa-download"></i> &nbsp;Download Course Module</a>
              </br>
              <ul>
              </br>
